...
const Index = () => {
  return <div className="min-h-screen pl-[50px]">
      ...
      <ArtworkTwoColumn images={[artwork3, artwork4]} titles={["Ojo mira a Ojo porque Ojo lo está mirando", "Eye looks at Eye because Eye is looking at it"]} descriptions={[Esta pieza fue creada especialmente para la Biblioteca
Vasconcelos de la Ciudad de México.
En los 6 pisos de la biblioteca se agrupan 40 performers que
sostienen 40 pliegos de papel, negro de un lado y blanco del otro.
Del lado del frente, una figura con las manos rojas y una vara del
mismo color, dirige el movimiento de los papeles componiendo un
lenguaje basado en el código binario de su estructura. La
coreografía es un ciclo que presenta diferentes maneras de leer:
lectura lineal, lectura espiral, lectura diagonal y lectura en la
oscuridad. Acompañan este movimiento una serie de textos leídos
en vivo por tres lectorxs.
Ojo mira a Ojo porque Ojo lo está mirando es una performance en
la que un cuerpo colectivo conforma una mira, la pupila de la
biblioteca que funciona como dispositivo y a la vez como destino y
objetivo de la mirada, al enfrentarse al público que viene a ver y al
mismo tiempo a ser leído.", "Una reinterpretación fotográfica de la vida urbana, donde los colores saturados y la composición dinámica capturan la energía de la ciudad."]} years={["2024", "2023"]} />
